...
struct DistanceHelper
{
    ...
    bool operator<( const DistanceHelper &rhs ) const
	{
...
struct Polygon
{
    void push_back( MeshEx::Vertex *v, math::Vec2d projectedPosition )
	{
...
//        Point myPoint;
//        myPoint.
        //std::cout << "*--CGAL::Orientation "<< vertexPoints.size() <<std::endl;
       // std::cout << " vertexPoints: ";
//        for (int i = 0; i < vertexPoints.size(); ++i)
//            std::cout << "(" << vertexPoints.at(i).x() << "," << vertexPoints.at(i).y() << ") ";
//        std::cout <<std::endl;

        CGAL::Orientation res;
        if(CGAL::is_simple_2(vertexPoints.begin(), vertexPoints.end() ))
            res = CGAL::orientation_2( vertexPoints.begin(), vertexPoints.end() );
//        std::cout << "Of cours its not crashing" << std::endl;
        return res;
	}
...
struct EdgeInfoHelper
{
    ...
    math::Vec2d     projected; // 2d coordinates within the plane onto which the vertex has been projected
};
...
//    std::cout << "8.1.1-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.2-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.3-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
	do
	{
...
//    std::cout << "8.1.4-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.5-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.6-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.7-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
    do
	{
        ...
        case  1:normal = math::normalize( math::Vec3d( .8507, .4472, .2764 ));break;
        case  2:normal = math::normalize( math::Vec3d( -.8507, .4472, .2764 ));break;
        case  3:normal = math::normalize( math::Vec3d( .8507, -.4472, -.2764 ));break;
        case  4:normal = math::normalize( math::Vec3d( -.8507, -.4472, -.2764 ));break;
        case  5:normal = math::normalize( math::Vec3d( .5257, -.4472, .7236 ));break;
        case  6:normal = math::normalize( math::Vec3d( .5257, .4472, -.7236 ));break;
        case  7:normal = math::normalize( math::Vec3d( -.5257, -.4472, .7236 ));break;
        case  8:normal = math::normalize( math::Vec3d( -.5257, .4472, -.7236 ));break;
        case  9:normal = math::normalize( math::Vec3d( .0, .4472, .8944 ));break;
        case 10:normal = math::normalize( math::Vec3d( .0, -1.0, .0 ));break;
        case 11:normal = math::normalize( math::Vec3d( .0, 1.0, .0 ));break;
        case 12:normal = math::normalize( math::Vec3d( .0, -.4472, -.8944 ));break;
		};
		...
		for( std::vector<Edge *>::iterator it1 = boundaryEdges.begin(); it1 != boundaryEdges.end() - 1; ++it1 )
		{
			for( std::vector<Edge *>::iterator it2 = it1+1; it2 != boundaryEdges.end(); ++it2 )
			{
                ...
                math::Vec2d e1_v1_projected = boundaryRing[e1->v1].projected;
                math::Vec2d e1_v2_projected = boundaryRing[e1->v2].projected;
                math::Vec2d e2_v1_projected = boundaryRing[e2->v1].projected;
                math::Vec2d e2_v2_projected = boundaryRing[e2->v2].projected;
		...
		if( success )
		{
            ...
            for( std::vector<Edge *>::iterator it = criticalEdges.begin(); it != criticalEdges.end(); ++it )
			{
                ...
                }while( current != criticalEdge->v2 && current!=NULL);
				leftPoly.push_back( current, boundaryRing[current].projected );
                ...
                }while( current != criticalEdge->v1 && current!=NULL);
				rightPoly.push_back( current, boundaryRing[current].projected );
...
//    std::cout << "8.1.8-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
	if( !success )
	{
...
//    std::cout << "8.1.9-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//    std::cout << "8.1.10-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "8.1.11-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
	// sort
...
//        std::cout << "8.1.12-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "8.1.13-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "8.1.14-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "--8.1.15-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "--8.1.16-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "--8.1.17-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//        std::cout << "**8.1.18-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//            std::cout << "**8.1.19-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
			...
			if( left->isTriangle() )
			{
//                std::cout << "**8.1.19.1-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
...
//                std::cout << "**8.1.19.2-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
             }

			if( right->isTriangle() )
			{
//                std::cout << "**8.1.19.3-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
				// add triangle to the mesh
...
//                std::cout << "**8.1.19.4-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
             }
		}else
        {
//            std::cout << "**8.1.20-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
			delete left;
			delete right;
		}
	}

//    std::cout << "**8.1.21-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
    if( !polygons.empty() )
...
//    std::cout << "**8.1.22-MeshEx::removeVertexAndReTriangulateNeighbourhood "<<std::endl;
    polygons.clear();
...
//
void MeshEx::retriangulateHole( std::vector<MeshEx::Edge *> &boundaryEdges, std::map<MeshEx::Vertex *, math::Vec2d> &boundaryVertexProjections, std::vector<std::pair<math::Vec3d, math::Vec2d> > &interiorPoints )
{
	...
	*/
    ...
    for( std::map<MeshEx::Vertex *, math::Vec2d>::iterator it = boundaryVertexProjections.begin(); it != boundaryVertexProjections.end(); ++it )
	{
    ...
    for( std::vector<std::pair<math::Vec3d, math::Vec2d> >::iterator it = interiorPoints.begin(); it != interiorPoints.end(); ++it )
	{
	...
	do
	{
		...
		for( std::vector<Edge *>::iterator it = m_edges.begin(); it != m_edges.end(); ++it )
		{
			...
			if( e->isBoundaryEdge() )
			{
                ...
                std::map<MeshEx::Vertex *, math::Vec2d> boundaryVertexProjections;

				for( std::vector<Edge *>::iterator eit = boundaryEdges.begin(); eit != boundaryEdges.end(); ++eit )
				{
					Edge *e = *eit;

                    boundaryVertexProjections[e->v1] = math::Vec2d();
                    boundaryVertexProjections[e->v2] = math::Vec2d();
				}

                math::Vec3d normal = boundaryVertexProjections.begin()->first->normal;
                double distance = -math::dotProduct( boundaryVertexProjections.begin()->first->position, normal );

				// compute the basis of the 2d-coordinate system of the plane defined by current normal
                math::Vec3d base1 = math::normalize( math::projectPointOnPlane( normal, distance, boundaryEdges[0]->v2->position - boundaryEdges[0]->v1->position ) );
                math::Vec3d base2 = math::normalize( math::crossProduct( normal, base1 ) );

                for( std::map<MeshEx::Vertex *, math::Vec2d>::iterator vit = boundaryVertexProjections.begin(); vit != boundaryVertexProjections.end(); ++vit )
				{
					// project neighbours into the given plane
                ...
                std::cout<< "INCLUDE DECLARATION FOR THE FUNCTION" << std::endl;
                std::vector<std::pair<math::Vec3d, math::Vec2d> > interiorPoints;
                retriangulateHole( boundaryEdges, boundaryVertexProjections, interiorPoints );
				done = false;
				break;
			}
		}
