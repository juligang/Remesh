...
public:
    ...
    RetileSurface(int iterationCount);                                                                       // constructor
...
private:
    ...
    size_t                                                                           m_iterationAroundEdge; // Itearion many times the point was rotated around an edge
};
